...
- `scripts/bootstrap/InputSetup.gd`: usa las constantes globales `MOUSE_BUTTON_*` y asigna los códigos enteros directos a los eventos para que Godot 4.4 deje de marcar errores al crear los bindings de ratón y teclado.
